...
const Hero = () => {
  return <div>
      ...
      <section className="hero-slice relative h-[35vh] overflow-hidden">
        <img src={heroMainPortrait} alt="Where Code Meets Design" className="w-full h-full object-cover object-center" />
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center space-y-4 max-w-4xl mx-auto px-6">
            <h1 className="hero-title text-4xl md:text-6xl lg:text-7xl font-bold text-ivory leading-tight">Anna Sebedach portfolio</h1>
            ...
            <div className="hero-ctas flex gap-4 justify-center pt-6">
              ...
              <Button variant="outline" className="border-moss-green text-moss-green hover:bg-moss-green hover:text-ivory px-6 py-3">I bridge the gap between technology and business strategy, creating solutions that drive meaningful impact.
