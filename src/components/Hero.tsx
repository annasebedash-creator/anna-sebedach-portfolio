...
const Hero = () => {
  return <div>
      ...
      <section className="hero-slice relative h-[calc(35vh+3cm)] overflow-hidden">
        <img src="/lovable-uploads/0cfb88b1-b7e7-4855-8bfb-c8d781a2665f.png" alt="Where Code Meets Design" className="w-full h-[calc(100%+3cm)] object-cover object-center absolute top-[-3cm] left-0" />
