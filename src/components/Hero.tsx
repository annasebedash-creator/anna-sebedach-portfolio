...
const Hero = () => {
  return <div>
      ...
      <section className="hero-slice relative h-[calc(35vh+3cm)] overflow-hidden">
        <img src="/lovable-uploads/4f99b67f-5796-4f42-9124-a97a96986460.png" alt="Where Code Meets Design" className="w-full h-[calc(100%+3cm)] object-cover object-[center_30%] absolute top-[-2cm] left-0" />
