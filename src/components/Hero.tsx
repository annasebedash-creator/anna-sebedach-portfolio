...
const Hero = () => {
  return <div>
      ...
      <section className="hero-slice relative h-[calc(35vh+3cm)] overflow-hidden">
        <img src="/lovable-uploads/8c0b4771-2ce3-4c62-89fc-cb006c684225.png" alt="Where Code Meets Design" className="w-full h-[calc(100%+3cm)] object-cover object-center absolute top-[-3cm] left-0" />
