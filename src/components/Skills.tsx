  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        "Excel", "Statistical Analysis", "KPI Design", 
    ...
    },
    {
      ...
      skills: [
        "Strategic Planning", "Market Analysis", "Process Optimization", 
        "Financial Analysis", "Risk Management", "Stakeholder Management",
    ...
    },
    {
      ...
      skills: [
        ...
        "Cross-functional Collaboration", "Mentoring", "Communication",
    ...
    <section id="skills" className="py-20 bg-gradient-subtle">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-4 gap-8 max-w-4xl mx-auto mt-16">
          {[
            { icon: <Target className="w-8 h-8" />, value: "5+", label: "Years Experience" },
            { icon: <Briefcase className="w-8 h-8" />, value: "20+", label: "Projects Completed" },
            { icon: <TrendingUp className="w-8 h-8" />, value: "15%", label: "Avg Cost Reduction" },
            { icon: <Cloud className="w-8 h-8" />, value: "3", label: "Certifications" }
          ].map((metric, index) => (
